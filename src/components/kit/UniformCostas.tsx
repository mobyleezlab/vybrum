...
export function UniformCostas({ colors, layers, playerNumber, playerName, onPartClick }: Props) {
      ...
      case "name":
        return (
          <g key="name" style={{ pointerEvents: "none" }}>
            <text x="1000" y="320" textAnchor="middle" fontFamily="Inter, sans-serif" fontSize="80" fontWeight="700" fill="#FFFFFF" stroke="#111" strokeWidth="2" letterSpacing="6">
              {playerName}
            </text>
          </g>
        );
      case "number":
        return (
          <g key="number" style={{ pointerEvents: "none" }}>
            <text x="1000" y="560" textAnchor="middle" fontFamily="Inter, sans-serif" fontSize="240" fontWeight="800" fill="#FFFFFF" stroke="#111" strokeWidth="3">
              {playerNumber}
            </text>
          </g>
        );
